    ...
    for (dirpath, dirnames, filenames) in os.walk(hd_skel_json_path):
        ...
        for filename in filenames:
            ...
            for id_ in range(len(bframe['bodies'])):
                ...
                bottom_center_bev = Point(bottom_center_cam[0] / 1000.0, bottom_center_cam[2] / 1000.0)
                ...
                in_triangle = point_in_triangle(bottom_center_bev, fov_pt_left, fov_pt_right, cam_center)

                if in_triangle is True and area_extents[0][0] < bottom_center_bev.x < area_extents[0][1]:
            ...
            sample_names.append('{0:02d}{1:02d}{2:02d}{3:06d}'.format(50, idk, seq_uid, cindex))
        ...
        valid_samples = [valid_sample for valid_sample in kinect_imgs_samples if valid_sample in sample_names]
